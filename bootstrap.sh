...
[[ "$SHELL" == */zsh ]] || { echo "Error: Please switch to the zsh shell to continue."; exit 1; }
...
if [[ -d "$TARGET" ]]; then
  echo "Error: Target directory ${TARGET} already exists. Please remove or rename it and try again."
  exit 1
fi
